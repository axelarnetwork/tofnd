    ...
    vec![
        ...
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(1, Honest),
                Signer::new(2, Honest),
                Signer::new(3, R2FalseAccusation { victim: 0 }),
            ],
            vec![3],
        ),
        TestCase::new(
        ...
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(1, Honest),
                Signer::new(2, Honest),
                Signer::new(3, R3FalseAccusationMta { victim: 0 }),
            ],
            vec![3],
        ),
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(1, Honest),
                Signer::new(2, Honest),
                Signer::new(3, R3FalseAccusationMtaWc { victim: 0 }),
            ],
            vec![3],
        ),
        TestCase::new(
    ...
    vec![
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(2, R2FalseAccusation { victim: 0 }),
            ],
            vec![1, 2],
        ),
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(3, R3FalseAccusationMta { victim: 0 }),
                Signer::new(4, R3FalseAccusationMtaWc { victim: 0 }),
            ],
            vec![1, 2, 3, 4],
        ),
        TestCase::new(
        ...
        TestCase::new(
            ...
            vec![
                ...
                Signer::new(6, R3FalseAccusationMta { victim: 2 }),
                Signer::new(7, R3FalseAccusationMtaWc { victim: 3 }),
            ],
            vec![4, 5, 6, 7],
        ),
        TestCase::new(
